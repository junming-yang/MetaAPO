...
def implicit_reward_processor(args, objs):
    out = {}
    for obj in tqdm(objs, desc="Implicit Reward process...."):
        input = obj["input"]
        output = obj["output"]
        reward = float(obj["logp_norm"])
...
PROCESSORS = {
    ...
    "implicit_reward": implicit_reward_processor,
}
