...
def train(args):
    ...
    if args.iter is None:
        ...
        train_data = train_data.select(range(start_idx, min(end_idx, len(train_data))))
    ...
    trainer.calculate_implicit_reward(args.reward_output_file)
...
if __name__ == "__main__":
    ...
    # reward output file
    parser.add_argument("--reward_output_file", type=str, default='./data/implicit_rewards.jsonl')
    ...
    # MetaAPO
    parser.add_argument("--rollout_batch_size", type=int, default=20240)
