...
PROJECT_NAME=metaapo-dpo-qwen2.5-7b
...
POLICY_MODEL_PATH=jmyang/Qwen2.5-7B-DPO
REF_POLICY_MODEL_PATH=FuseAI/FuseChat-Qwen-2.5-7B-SFT
RM_MODEL_PATH=jmyang/Qwen2.5-7B-rm
